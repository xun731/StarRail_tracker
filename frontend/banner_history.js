...
const RAW_BANNER_DATES = [
  ...
  // ─── 4.x ────────────────────────────────────────────────────────────────
  // 4.x 在 fandom 還沒收，依 3 週節奏估算。實際上線後請依官方公告修正
  { v: '4.0', p: '第一期', s: '2026-02-13', e: '2026-03-05' },
  { v: '4.0', p: '第二期', s: '2026-03-05', e: '2026-03-26' },
  { v: '4.1', p: '第一期', s: '2026-03-27', e: '2026-04-16' },
  { v: '4.1', p: '第二期', s: '2026-04-16', e: '2026-05-06' },
  // 4.2+ 需要你補上：在 banner_chars.js 加 UP 角色，在這邊加日期
];
...
(function buildBannerHistory() {
  ...
  for (const d of RAW_BANNER_DATES) {
    ...
    const start = `${d.s} 06:00:00`;
    const end   = `${d.e} 14:59:59`;
